...
:warning: NOTE, however, that `unsafe-eval` is NOT recommended in a secure CSP[[Sah Launch]](https://developer.chrome.com/extensions/contentSecurityPolicy#relaxing-eval), as it has the potential to open the document to cross-site scripting (XSS) attacks.
